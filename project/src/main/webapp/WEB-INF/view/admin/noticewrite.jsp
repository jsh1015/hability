...
<form:form modelAttribute="notice" action="noticewrite.shop" name="f">
<table border="1">
	<tr><th colspan="2"><h3>공지사항등록</h3></th></tr>
	<tr><td>구분</td>
	<td>
	...
	<tr><td colspan="2" style="text-align:right;"><button type="submit">등록</button> </td></tr>
</table>
</form:form>
</div>
